defmodule SymphonyElixir.CoreTest do
  ...
  test "config defaults and validation checks" do
    ...
    write_workflow_file!(Workflow.workflow_file_path(),
      schema_version: 1,
      agent_backend: "claude",
      claude_version_range: "not-a-range"
    )
  ...
  test "agent runner fails fast when workflow selects an unsupported backend" do
    issue = %Issue{
    ...
    write_workflow_file!(Workflow.workflow_file_path(), agent_backend: "ghost")
